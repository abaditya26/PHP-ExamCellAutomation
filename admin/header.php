            ...
            <nav class="navbar navbar-dark bg-dark navbar-expand-lg" style="padding-left: 10%; padding-right: 10%;">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav flex-fill justify-content-center">
                        ...
                        <li class="nav-item flex-fill <?php if($page=="dashboard"){echo "active";} ?>">
                        ...
                        <li class="nav-item flex-fill <?php if($page=="students-request"){echo "active";} ?>">
                            <a class="nav-link" href="./studentrequests.php">Students' Management</a>
                        </li>

                        <li class="nav-item flex-fill <?php if($page=="examination"){echo "active";} ?>">
                            <a class="nav-link" href="./examination.php">Examination</a>
                        </li>
                        
                        <li class="nav-item flex-fill <?php if($page=="manage-home-page"){echo "active";} ?>">
